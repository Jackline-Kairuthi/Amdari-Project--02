...
def get_account(account_id):
    """Look up an account by ID, scoped to the current user.
...
def update_profile(account_id):
    """Update account profile fields for the current user's account.
    ...
    values = list(data.values()) + [account_id, current_user_id]
